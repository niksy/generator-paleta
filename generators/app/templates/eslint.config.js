<% var files = []; if ( manualTests || integrationTests ) { files.push("test/manual/vite.config.js"); } if ( automatedTests && browserModule && !sassModule ) {
files.push("karma.conf.js"); } if ( integrationTests ) {
files.push("wdio.conf.js"); } if ( transpile && (bundleCjs || (browserModule && !sassModule)) ) {
files.push("rolldown.config.js"); } %>import { defineConfig } from 'eslint/config';
